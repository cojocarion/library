<?php /* Smarty version 2.6.28, created on 2020-04-26 12:00:23
...
">
        <table id="filetable" class="display" border="0" cellpadding="1" cellspacing="1">
            ...
            <tbody>
                <?php $_from = $this->_tpl_vars['file_list_arr'];
                if (!is_array($_from) && !is_object($_from)) {
                    settype($_from, 'array');
                }
                $this->_foreach['file_list'] = array('total' => count($_from), 'iteration' => 0);
